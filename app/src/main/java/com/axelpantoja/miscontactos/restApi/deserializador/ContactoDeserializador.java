package com.axelpantoja.miscontactos.restApi.deserializador;

import com.axelpantoja.miscontactos.pojo.Contacto;
import com.axelpantoja.miscontactos.restApi.JsonKeys;
...
/**
 * Created by axelpantoja on 06/02/17.
 */
...
public class ContactoDeserializador implements JsonDeserializer<ContactoResponse> {
    ...
    private ArrayList<Contacto> deserializarContactoDeJson(JsonArray contactoResponseData) {
        ...
        for (int i = 0; i < contactoResponseData.size(); i++) {
            ...
            Contacto contactoActual = new Contacto(nombreCompleto, urlFoto, likes);
